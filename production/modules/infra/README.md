...
1. [Setup - The basics of getting started with infra](#setup)
    * [What infra affects](#what-infra-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with infra](#beginning-with-infra)
